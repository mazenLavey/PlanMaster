    ...
    return (
        ...
        <div 
            ...
            <div className="PlanCard__Progress">
                <p className="PlanCard__ProgressText">{doneTasks()} of {tasksSum()} Tasks { data?.isFinished && <FontAwesomeIcon icon={faCircleCheck} size="sm" color="#34C759"/>}</p>
